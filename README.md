...
- `WATCH_IMPORT_STRICT`: 워치 폴더 반영 실패 시 즉시 오류 반환 (`true` / `false`)
...
- `AUTO_REMOVE_FINISHED`: 완료/시딩 항목 자동 삭제 (`true` / `false`)
- `AUTO_REMOVE_FINISHED_INTERVAL_SEC`: 완료/시딩 항목 정리 주기(초)
